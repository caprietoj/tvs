...
class PurchaseRequestApproved extends Notification
{
    ...
    {
        // Personalizar mensaje según el tipo de destinatario
        $message = $this->buildBaseMessage();
        
        // Solo adjuntar PDF para compras y contabilidad, NO para el usuario
    ...
    /**
     * Construir el mensaje base según el destinatario
     */
    private function buildBaseMessage(): MailMessage
    {
        ...
        if ($this->recipient === 'user') {
            // Mensaje para el usuario (sin adjunto PDF)
            ...
            // Agregar información de la cotización seleccionada
            ...
            // Mensaje para compras (con adjunto PDF)
            ...
            // Mensaje para contabilidad (con adjunto PDF)
    ...
    /**
     * Adjuntar PDF de orden de compra con nueva plantilla
     */
    private function attachPurchaseOrderPdf(MailMessage $message): void
    {
        try {
            ...
            if ($purchaseOrder) {
                ...
                Log::warning('No se encontró orden de compra para adjuntar PDF', [
                    'purchase_request_id' => $this->purchaseRequest->id,
                    'recipient' => $this->recipient
                ]);
            }
