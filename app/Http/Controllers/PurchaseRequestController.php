    ...
    */    private function updateCopiesRequest(Request $request, PurchaseRequest $purchaseRequest)
    {
        $validator = Validator::make($request->all(), [
            ...
            'paper_type' => 'nullable|string|in:Bond 75g,Bond 90g,Propalcote 115g,Propalcote 150g,Cartulina,Opalina,Papel adhesivo,Acetato para impresion,Durex,Acuarella',
