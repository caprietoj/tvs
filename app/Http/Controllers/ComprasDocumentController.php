...
use App\Models\ComprasDocument;
...
class ComprasDocumentController extends Controller
{
    ...
    {
        $documents = ComprasDocument::with('user')->latest()->get();
        return view('compras.documents.index', compact('documents'));
    }
    ...
    {
        return view('compras.documents.create');
    }
