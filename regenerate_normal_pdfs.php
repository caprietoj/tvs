...
echo "Regenerando PDFs de órdenes normales sin datos personalizados...\n";
...
foreach ($orders as $order) {
    try {
        ...
        if ($request && !$request->quotationItemSelections()->exists() && !$request->isNoQuotationService()) {
            echo "Regenerando " . $order->order_number . "...\n";
...
echo "Proceso completado: " . $regenerated . " PDFs regenerados, " . $errors . " errores\n";
