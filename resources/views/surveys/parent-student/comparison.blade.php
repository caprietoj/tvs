...
@section('content')
    @php
        ...
        $comparisonData = [
            ...
            'cafeteria_period1' => [
                'total_usuarios' => 32,
                'calidad_sabor' => 68.5,
                'porcion_satisfaccion' => 72.1,
                'menu_calidad' => 65.3,
                'variedad_menu' => 58.7,
                'temperatura_adecuada' => 71.2,
                'limpieza_comedor' => 76.5,
                'trato_personal_cafeteria' => 69.8,
                'trato_personal' => 69.8
            ],
            'cafeteria_period2' => [
                'total_usuarios' => 48,
                'calidad_sabor' => 78.2,
                'porcion_satisfaccion' => 81.5,
                'menu_calidad' => 75.8,
                'variedad_menu' => 73.4,
                'temperatura_adecuada' => 79.6,
                'limpieza_comedor' => 84.3,
                'trato_personal_cafeteria' => 82.1,
                'trato_personal' => 82.1
            ],
            
            // Datos detallados de transporte por período
            'transport_period1' => [
                'total_usuarios' => 28,
                'puntualidad' => 15.2,
                'limpieza_vehiculo' => 28.6,
                'trato_personal' => 62.3,
                'comunicacion' => 18.7
            ],
            'transport_period2' => [
                'total_usuarios' => 47,
                'puntualidad' => 23.4,
                'limpieza_vehiculo' => 35.7,
                'trato_personal' => 85.0,
                'comunicacion' => 26.5
            ],
            
            // Diferencias calculadas para la vista resumida
            'cafeteria_differences' => [
                'food_quality' => [
                    'period1' => 68.5,
                    'period2' => 78.2,
                    'difference' => 9.7,
    ...
    @else
    @php
        // Datos ficticios para los períodos disponibles
        $periods = collect([
            (object)['period' => '2025-06', 'year' => 2025, 'month' => 6],
            (object)['period' => '2024-05', 'year' => 2024, 'month' => 5],
            (object)['period' => '2024-03', 'year' => 2024, 'month' => 3],
            (object)['period' => '2023-11', 'year' => 2023, 'month' => 11],
            (object)['period' => '2023-05', 'year' => 2023, 'month' => 5]
        ]);
    @endphp
        ...
        <div class="card-body">
            ...
            <div class="tab-content mt-3" id="analysisTabContent">
                ...
                <div class="tab-pane fade show active" id="basic" role="tabpanel">
                    ...
                    <form action="{{ route('surveys.parent-student.comparison') }}" method="GET" id="basicAnalysisForm">
                ...
                <div class="tab-pane fade" id="provider" role="tabpanel">
                    ...
                    <form action="{{ route('surveys.parent-student.comparison') }}" method="GET" id="providerAnalysisForm">
                ...
                <div class="tab-pane fade" id="grade" role="tabpanel">
                    ...
                    <form action="{{ route('surveys.parent-student.comparison') }}" method="GET" id="gradeAnalysisForm">
                ...
                <div class="tab-pane fade" id="route" role="tabpanel">
                    ...
                    <form action="{{ route('surveys.parent-student.comparison') }}" method="GET" id="routeAnalysisForm">
    ...
    <div class="card card-secondary collapsed-card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-3">
                    <a href="{{ route('surveys.parent-student.export', ['type' => 'executive']) }}" class="btn btn-block btn-outline-primary">
                        <i class="fas fa-chart-pie"></i><br>
                        Resumen Ejecutivo
                    </a>
                </div>
                <div class="col-md-3">
                    <a href="{{ route('surveys.parent-student.export', ['type' => 'provider-change']) }}" class="btn btn-block btn-outline-warning">
                        <i class="fas fa-exchange-alt"></i><br>
                        Cambio de Proveedor
                    </a>
                </div>
                <div class="col-md-3">
                    <a href="{{ route('surveys.parent-student.export', ['type' => 'grade-analysis']) }}" class="btn btn-block btn-outline-success">
                        <i class="fas fa-graduation-cap"></i><br>
                        Análisis por Grados
                    </a>
                </div>
                <div class="col-md-3">
                    <a href="{{ route('surveys.parent-student.export', ['type' => 'action-plan']) }}" class="btn btn-block btn-outline-info">
