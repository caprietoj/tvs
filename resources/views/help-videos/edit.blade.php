...
@section('title', 'Editar Video de Ayuda')

@section('content_header')
    <div class="row">
        <div class="col-sm-6">
            <h4>Editar Video de Ayuda</h4>
        </div>
        <div class="col-sm-6">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                ...
                Editar Video: {{ $helpVideo->title }}
            </h3>
        </div>
        
        <form action="{{ route('help-videos.update', $helpVideo) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="card-body">
                @if($errors->any())
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   id="title" 
                                   name="title" 
                                   value="{{ old('title', $helpVideo->title) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="4" 
                                      placeholder="Describe brevemente el contenido del video (opcional)">{{ old('description', $helpVideo->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                <img src="{{ $helpVideo->thumbnail }}" class="img-fluid rounded" alt="Vista previa">
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="card bg-warning">
                            ...
                            <div class="card-body">
                                <p class="mb-2"><strong>Creado:</strong></p>
                                <p class="mb-2">{{ $helpVideo->created_at->format('d/m/Y H:i') }}</p>
                                @if($helpVideo->updated_at != $helpVideo->created_at)
                                    <p class="mb-2"><strong>Última modificación:</strong></p>
                                    <p class="mb-0">{{ $helpVideo->updated_at->format('d/m/Y H:i') }}</p>
                                @endif
                            </div>
                        </div>
                    </div>
