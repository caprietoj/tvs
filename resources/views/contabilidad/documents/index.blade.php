...
@section('title', 'Gestión Documental - Contabilidad')

@section('content_header')
    <h1 class="text-primary">Gestión Documental - Contabilidad</h1>
@stop
...
<div class="card custom-card">
    <div class="card-header" style="background-color: #364E76;">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('contabilidad.documents.create') }}" class="btn btn-light">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="{{ route('contabilidad.documents.download', $document->id) }}" 
                                       class="btn btn-sm btn-info" title="Descargar">
                                        <i class="fas fa-download"></i>
                                    </a>
                                    <form action="{{ route('contabilidad.documents.destroy', $document->id) }}" 
                                          method="POST" 
