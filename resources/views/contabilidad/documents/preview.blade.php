...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="{{ route('contabilidad.documents.download', $document->id) }}" class="btn btn-success">
        ...
        <div class="pdf-viewer-container">
            <iframe 
                ...
                <p>Su navegador no soporta la visualización de PDFs. 
                   <a href="{{ route('contabilidad.documents.download', $document->id) }}">Descargar el archivo</a>
                </p>
            </iframe>
        </div>
    </div>
