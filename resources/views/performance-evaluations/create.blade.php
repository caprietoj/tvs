    ...
    <form action="{{ route('performance-evaluations.store') }}" method="POST" id="evaluation-form">
        ...
        <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                ...
                </div>                <!-- Employee and Evaluator Info Cards -->
                <div class="row mt-3" id="selected-info" style="display: none;">
                    <div class="col-md-8">
                        <div class="info-box bg-light">
                            <span class="info-box-icon bg-primary"><i class="fas fa-users"></i></span>
                            <div class="info-box-content">
                                <span class="info-box-text">Empleados Seleccionados</span>
                                <span class="info-box-number" id="selected-employees-count">0</span>
                                <div id="selected-employees-list" class="mt-2"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
        ...
        <div class="card">
            <div class="card-footer bg-light">
                <div class="row">
                    <div class="col-md-6">                        <button type="submit" class="btn btn-primary btn-lg" id="create-evaluations-btn">
                            <i class="fas fa-save"></i> <span id="btn-text">Crear Evaluación</span>
                        </button>
...
<style>
    ...
    .selected-employee-item .remove-employee {
        margin-left: 5px;
        cursor: pointer;
        color: #f44336;
        font-weight: bold;
    ...
    .selected-employee-item .remove-employee:hover {
        color: #d32f2f;
    }
