...
@section('title', 'Estructura de Carpeta - Sistemas')
...
<div class="card custom-card">
    <div class="card-header" style="background-color: #364E76;">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="{{ route('sistemas.documents.download', $document->id) }}" class="btn btn-light btn-sm mr-2">
                    <i class="fas fa-download mr-1"></i>Descargar ZIP
                </a>
                <a href="{{ route('sistemas.documents.index') }}" class="btn btn-secondary btn-sm">
        ...
        <div class="card">
            ...
            <div class="card-body">
                @if($document->folder_structure)
                    <div id="file-tree">
                        @include('sistemas.documents.partials.folder', ['folderData' => $document->folder_structure, 'folderName' => $document->original_filename, 'level' => 0])
                    </div>
                @else
