...
@section('title', 'Gestión Documental - Sistemas')

@section('content_header')
    <h1 class="text-primary">Gestión Documental - Sistemas</h1>
@stop
...
<div class="card custom-card">
    <div class="card-header" style="background-color: #364E76;">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('sistemas.documents.create') }}" class="btn btn-light">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="{{ route('sistemas.documents.preview', $document->id) }}" 
