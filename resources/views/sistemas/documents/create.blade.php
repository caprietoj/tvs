...
@section('title', 'Subir Documento - Sistemas')

@section('content_header')
    <h1 class="text-primary">Subir Documento - Sistemas</h1>
@stop
...
<div class="card custom-card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('sistemas.documents.store') }}" method="POST" enctype="multipart/form-data" id="uploadForm">
            @csrf
            <div class="row">
                <div class="col-md-8">
            ...
            <div class="alert alert-info mt-3">
                <div class="d-flex">
                    ...
                    <div>
                        ...
                        <p class="mb-0">Los documentos subidos serán accesibles para todo el personal autorizado del departamento de Sistemas. Asegúrese de que el documento no contenga información sensible o confidencial.</p>
                    </div>
                </div>
            </div>

            <div class="mt-4 d-flex justify-content-between">
                <a href="{{ route('sistemas.documents.index') }}" class="btn btn-secondary">
