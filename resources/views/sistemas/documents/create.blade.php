            ...
            <div class="alert alert-info mt-3" id="file-info">
                <div class="d-flex">
                    ...
                    <div>
                        ...
                        <p class="mb-0">Los documentos subidos serán accesibles para todo el personal autorizado del departamento de Sistemas. Asegúrese de que el documento esté completo y sea legible.</p>
                    </div>
                </div>
            </div>
