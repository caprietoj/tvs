            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="page-title">
                        ...
                        Editar Previsita #{{ $previsita->id }}
                    </h1>
                    <p class="page-subtitle">Modifique la información de la previsita existente</p>
                </div>
                <div class="col-sm-6">
                    <div class="float-sm-right">
                        <a href="{{ route('previsitas.show', $previsita) }}" class="btn btn-outline-info btn-sm mr-2">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <form action="{{ route('previsitas.update', $previsita) }}" method="POST" enctype="multipart/form-data" id="previsita-form">
                        @csrf
                        @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="select-wrapper">
                                            <select class="form-control form-control-modern @error('aprobacion_sitio') is-invalid @enderror" 
                                                ...
                                                <option value="1" {{ old('aprobacion_sitio', $previsita->aprobacion_sitio ? '1' : '0') == '1' ? 'selected' : '' }}>
                                                    ✅ Aprobado
                                                </option>
                                                <option value="0" {{ old('aprobacion_sitio', $previsita->aprobacion_sitio ? '1' : '0') == '0' ? 'selected' : '' }}>
                                                    ❌ Pendiente
                                                </option>
                                            </select>
                                        </div>
                        ...
                        <!-- Sección 4: Archivos Existentes -->
                        @if($previsita->archivos && $previsita->archivos->count() > 0)
                        <div class="form-section existing-files-section">
                            <div class="section-header">
                                <h4 class="section-title">
                                    <i class="fas fa-folder text-warning mr-2"></i>
                                    Archivos Existentes
                                </h4>
                                <p class="section-description">Gestione los archivos ya subidos</p>
                            </div>
                            
                            <div class="existing-files-grid">
                                @foreach($previsita->archivos as $archivo)
                                    <div class="archivo-existente" data-archivo-id="{{ $archivo->id }}">
                                        <div class="archivo-info">
                                            ...
                                            <div class="archivo-details">
                                                ...
                                                <div class="archivo-size">{{ $archivo->tamaño_formateado }}</div>
                                            </div>
                                        </div>
                                        <div class="archivo-actions">
                                            ...
                                            <button type="button" 
                                                    class="btn btn-sm btn-outline-danger eliminar-archivo" 
                        ...
                        <div class="form-section">
                            <div class="section-header">
                                ...
                                <p class="section-description">Proporcione o actualice el enlace de Google Drive con los documentos relacionados</p>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="url" 
                                                   ...
                                                   id="drive_link" 
                                                   name="drive_link"
                                                   value="{{ old('drive_link', $previsita->drive_link) }}"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-modern @error('observaciones_recomendaciones') is-invalid @enderror" 
                                                  ...
                                                  rows="5" 
                                                  placeholder="Describa observaciones importantes, recomendaciones, medidas de seguridad, etc...">{{ old('observaciones_recomendaciones', $previsita->observaciones_recomendaciones) }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="action-buttons">
                                        ...
                                        <a href="{{ route('previsitas.show', $previsita) }}" class="btn btn-outline-info btn-lg">
            ...
            <div class="card card-info card-outline">
                ...
                <div class="card-body">
                    <div class="info-item">
                        ...
                        <div class="info-value">{{ $previsita->user->name ?? 'N/A' }}</div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value">{{ $previsita->created_at->format('d/m/Y H:i') }}</div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value">{{ $previsita->updated_at->format('d/m/Y H:i') }}</div>
                    </div>
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value">
                                <span class="badge badge-info badge-lg">
                                    {{ $previsita->archivos->count() }} archivo(s)
                                </span>
                            </div>
                        </div>
                    @endif
...
<style>
    ...
    /* Estados específicos para select de aprobación */
    #aprobacion_sitio option[value="1"] {
        color: #28a745;
        font-weight: 500;
    }
    
    #aprobacion_sitio option[value="0"] {
        color: #ffc107;
        font-weight: 500;
    }
    
    #aprobacion_sitio:focus option[value="1"] {
        background-color: #d4edda;
        color: #155724;
    }
    
    #aprobacion_sitio:focus option[value="0"] {
    ...
    $(document).ready(function() {
        ...
        function updateUploadAreaText() {
            ...
            if (selectedFiles.length > 0) {
                content.find('h5').text(`${selectedFiles.length} nuevo(s) archivo(s) seleccionado(s)`);
                content.find('p').html(`
        ...
        function updateFileIndices() {
            ...
            if (remainingCount > 0) {
                $('#archivos-seleccionados h6').html(`
                    <i class="fas fa-paperclip mr-2"></i>
                    Nuevos Archivos Seleccionados (${remainingCount})
                `);
            } else {
        ...
        $(document).on('click', '.eliminar-archivo', function() {
            if (confirm('¿Está seguro de eliminar este archivo? Esta acción no se puede deshacer.')) {
                ...
                const elemento = $(this).closest('.archivo-existente');
                ...
                $.ajax({
                    url: '/previsitas/archivos/' + archivoId,
                    type: 'DELETE',
                    data: {
                        '_token': '{{ csrf_token() }}'
                    },
                    success: function(response) {
                        elemento.fadeOut(500, function() {
                            $(this).remove();
                            // Si no quedan archivos existentes, ocultar la sección
                            if ($('.archivo-existente').length === 0) {
                                $('.existing-files-section').fadeOut(300);
                            }
                        });
                    ...
                    error: function(xhr) {
                        ...
                        showAlert('Error al eliminar el archivo. Inténtelo nuevamente.', 'danger');
                    }
                });
            }
        });
        ...
        function validateDates() {
            ...
            if (fechaVisita && vencimiento) {
                if (new Date(vencimiento) < new Date(fechaVisita)) {
                    ...
                    $('#vencimiento').val('{{ $previsita->vencimiento ? $previsita->vencimiento->format('Y-m-d') : '' }}').focus();
                }
            }
        }
        ...
        $('#previsita-form').on('submit', function(e) {
            ...
            if (!isValid) {
                ...
                submitBtn.html('<i class="fas fa-spinner fa-spin mr-2"></i>Actualizando...').prop('disabled', true);
