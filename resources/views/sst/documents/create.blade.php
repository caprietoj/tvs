...
@section('title', 'Subir Documento - SST - Seguridad y Salud en el Trabajo')

@section('content_header')
    <h1 class="text-primary">Subir Documento - SST - Seguridad y Salud en el Trabajo</h1>
@stop
...
<div class="card main-card custom-card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('sst.documents.store') }}" method="POST" enctype="multipart/form-data" id="uploadForm">
            @csrf
            <div class="row">
                <div class="col-md-8">
            ...
            <div class="alert alert-info mt-3">
                <div class="d-flex">
                    ...
                    <div>
                        ...
                        <p class="mb-2">Los documentos subidos serán accesibles para todo el personal autorizado del departamento de SST - Seguridad y Salud en el Trabajo.</p>
                        <p class="mb-0">
            ...
            <div class="mt-4 d-flex justify-content-between">
                <a href="{{ route('sst.documents.index') }}" class="btn btn-secondary">
