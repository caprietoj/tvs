...
@section('title', 'Subir Documento - Compras')

@section('content_header')
    <h1 class="text-primary">Subir Documento - Compras</h1>
@stop
...
<div class="card custom-card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('compras.documents.store') }}" method="POST" enctype="multipart/form-data" id="uploadForm">
            @csrf
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="name" id="name" 
                                ...
                                placeholder="Ej: Orden de Compra 2023-001">
                        </div>
                        @error('name')
            ...
            <div class="alert alert-info mt-3">
                <div class="d-flex">
                    ...
                    <div>
                        ...
                        <p class="mb-0">Los documentos subidos serán accesibles para todo el personal autorizado del departamento de Compras. Asegúrese de que el documento no contenga información sensible o confidencial.</p>
                    </div>
                </div>
            </div>
