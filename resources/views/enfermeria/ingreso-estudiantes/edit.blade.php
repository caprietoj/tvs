...
@section('title', 'Editar Atención de Estudiante - Enfermería')
...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="text-warning">
            <i class="fas fa-edit mr-2"></i>Editar Atención de Estudiante
        </h1>
        <div>
...
@section('content')
    <div class="row">
        <div class="col-12">
            <form action="{{ route('enfermeria.ingreso_estudiantes.update', $ingreso->id) }}" method="POST" class="enfermeria-form">
                @csrf
                @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" 
                                           ...
                                           id="fecha" 
                                           name="fecha" 
                                           value="{{ old('fecha', $ingreso->fecha ? $ingreso->fecha->format('Y-m-d') : '') }}" 
                                           required>
                                    @error('fecha')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" 
                                           ...
                                           id="hora" 
                                           name="hora" 
                                           value="{{ old('hora', substr($ingreso->hora, 0, 5)) }}" 
                                           required>
                                    @error('hora')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                ...
                <div class="card card-outline card-info mb-3">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="estudiante" 
                                           name="estudiante" 
                                           value="{{ old('estudiante', $ingreso->estudiante) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('apellidos_estudiante', $ingreso->apellidos_estudiante) }}" 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('codigo_estudiante', $ingreso->codigo_estudiante) }}" 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('documento_estudiante', $ingreso->documento_estudiante) }}" 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="eps_estudiante" 
                                           name="eps_estudiante" 
                                           value="{{ old('eps_estudiante', $ingreso->eps_estudiante) }}" 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('sexo_estudiante', $ingreso->sexo_estudiante) == 'M' ? 'Masculino' : (old('sexo_estudiante', $ingreso->sexo_estudiante) == 'F' ? 'Femenino' : '') }}"
                                           placeholder="Sexo del estudiante"
                                           readonly>
                                    <input type="hidden" 
                                           id="sexo_estudiante" 
                                           name="sexo_estudiante" 
                                           value="{{ old('sexo_estudiante', $ingreso->sexo_estudiante) }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('tipo_sangre_estudiante', $ingreso->tipo_sangre_estudiante) }}" 
                        ...
                        <input type="hidden" id="estudiante_id" name="estudiante_id" value="{{ old('estudiante_id', $ingreso->estudiante_id) }}">
                    </div>
                </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-lg @error('viene_de') is-invalid @enderror" 
                                        ...
                                        <option value="Clase Magistral" {{ old('viene_de', $ingreso->viene_de) == 'Clase Magistral' ? 'selected' : '' }}>
                                            📚 Clase Magistral
                                        </option>
                                        <option value="Educacion Fisica" {{ old('viene_de', $ingreso->viene_de) == 'Educacion Fisica' ? 'selected' : '' }}>
                                            ⚽ Educación Física
                                        </option>
                                        <option value="Extracurricular" {{ old('viene_de', $ingreso->viene_de) == 'Extracurricular' ? 'selected' : '' }}>
                                            🎨 Extracurricular
                                        </option>
                                        <option value="Descanso" {{ old('viene_de', $ingreso->viene_de) == 'Descanso' ? 'selected' : '' }}>
                                            ☕ Descanso
                                        </option>
                                    </select>
                                    @error('viene_de')
