...
@section('title', 'Detalle de Atención de Colaborador - Enfermería')
...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="text-info">
            <i class="fas fa-eye mr-2"></i>Detalle de Atención de Colaborador
        </h1>
        <div>
            <a href="{{ route('enfermeria.ingreso_colaboradores.edit', $ingreso->id) }}" class="btn btn-warning">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <p class="form-control-plaintext border rounded p-2 bg-light">
                                    {{ $ingreso->fecha ? \Carbon\Carbon::parse($ingreso->fecha)->format('d/m/Y') : 'No registrada' }}
                                </p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <p class="form-control-plaintext border rounded p-2 bg-light">
                                    {{ $ingreso->hora ? \Carbon\Carbon::parse($ingreso->hora)->format('H:i') : 'No registrada' }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <p class="form-control-plaintext border rounded p-2 bg-light">
                                    {{ $ingreso->nombre_completo ?: 'No registrado' }}
                                </p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <p class="form-control-plaintext border rounded p-2 bg-light">
                                    {{ $ingreso->documento_colaborador ?: 'No registrado' }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <p class="form-control-plaintext border rounded p-2 bg-light">
                                    {{ $ingreso->eps_colaborador ?: 'No registrada' }}
                                </p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <p class="form-control-plaintext border rounded p-2 bg-light">
                                    @if($ingreso->sexo_colaborador == 'M')
                                        Masculino
                                    @elseif($ingreso->sexo_colaborador == 'F')
                                        Femenino
                                    @else
                                        No registrado
                                    @endif
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <p class="form-control-plaintext border rounded p-2 bg-light">
                                    {{ $ingreso->tipo_sangre_colaborador ?: 'No registrado' }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="font-weight-bold">
                                    <i class="fas fa-directions mr-1"></i>Derivación del Colaborador
                                </label>
                                <p class="form-control-plaintext border rounded p-2 bg-light">
                                    {{ $ingreso->derivacion_colaborador ?: 'No registrada' }}
                                </p>
                            </div>
                        </div>
                    </div>
...
@section('js')
    <script>
        console.log('Vista de detalle de ingreso de colaborador cargada.');
    </script>
@stop
