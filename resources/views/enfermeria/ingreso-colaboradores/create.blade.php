...
@section('title', 'Nueva Atención de Colaborador - Enfermería')
...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="text-primary">
            <i class="fas fa-user-tie mr-2"></i>Nueva Atención de Colaborador
        </h1>
        <div>
...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <form action="{{ route('enfermeria.ingreso_colaboradores.store') }}" method="POST" class="enfermeria-form">
                @csrf
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 mb-3">
                                <div class="form-group">
                                    <label for="buscar_empleado" class="font-weight-bold">
                                        <i class="fas fa-search mr-1"></i>Buscar Empleado
                                    </label>
                                    <input type="text" 
                                           class="form-control form-control-lg" 
                                           id="buscar_empleado" 
                                           placeholder="Escriba el nombre o documento del empleado..."
                                           autocomplete="off">
                                    <small class="form-text text-muted">
                                        <i class="fas fa-info-circle mr-1"></i>
                                        Escriba al menos 2 caracteres para buscar. Use nombre o documento.
                                    </small>
                                    <div id="empleados-dropdown" class="empleados-dropdown" style="display: none;"></div>
                                    
                                    <!-- Mensaje de ayuda -->
                                    <div id="mensaje-seleccionar" class="alert alert-info mt-2" style="display: block;">
                                        <i class="fas fa-lightbulb mr-1"></i>
                                        <strong>Paso 1:</strong> Busque y seleccione un empleado del sistema. Los demás campos se llenarán automáticamente.
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <!-- Campos que se llenan automáticamente después de seleccionar empleado -->
                        <div id="empleado-seleccionado" style="display: none;">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('documento_colaborador') }}" 
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-lg @error('area_colaborador') is-invalid @enderror" 
                                            ...
                                            <option value="DOCENTE" {{ old('area_colaborador') == 'DOCENTE' ? 'selected' : '' }}>DOCENTE</option>
                                            <option value="ADMINISTRATIVO" {{ old('area_colaborador') == 'ADMINISTRATIVO' ? 'selected' : '' }}>ADMINISTRATIVO</option>
                                            <option value="SERV. GENS. Y MTO." {{ old('area_colaborador') == 'SERV. GENS. Y MTO.' ? 'selected' : '' }}>SERV. GENS. Y MTO.</option>
                                            <option value="TRANSPORTE" {{ old('area_colaborador') == 'TRANSPORTE' ? 'selected' : '' }}>TRANSPORTE</option>
                                            <option value="OTRO" {{ old('area_colaborador') == 'OTRO' ? 'selected' : '' }}>OTRO</option>
                                        </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               class="form-control form-control-lg @error('tipo_sangre_colaborador') is-invalid @enderror" 
                                               id="tipo_sangre_colaborador" 
                                               name="tipo_sangre_colaborador" 
                                               value="{{ old('tipo_sangre_colaborador') }}" 
                                    ...
                                    <select class="form-control form-control-lg @error('motivo') is-invalid @enderror" 
                                        ...
                                        @if(isset($motivos) && count($motivos) > 0)
                                            @foreach($motivos as $motivo)
                                                <option value="{{ $motivo->nombre }}" {{ old('motivo') == $motivo->nombre ? 'selected' : '' }}>
                                                    {{ $motivo->icono }} {{ $motivo->nombre }}
                                                </option>
                                            @endforeach
                                        @else
