...
@section('title', 'Editar Estudiante - Parametrización')
...
@section('content')
    <div class="row">
        <div class="col-12">
            <form action="{{ route('estudiantes.update', $estudiante) }}" method="POST" class="estudiante-form">
                @csrf
                @method('PUT')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="apellido_1" 
                                           name="apellido_1" 
                                           value="{{ old('apellido_1', $estudiante->apellido_1) }}" 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-lg @error('curso') is-invalid @enderror" 
                                        ...
                                        <option value="Preescolar" {{ old('curso', $estudiante->curso) == 'Preescolar' ? 'selected' : '' }}>Preescolar</option>
                                        <option value="1°" {{ old('curso', $estudiante->curso) == '1°' ? 'selected' : '' }}>Primero (1°)</option>
                                        <option value="2°" {{ old('curso', $estudiante->curso) == '2°' ? 'selected' : '' }}>Segundo (2°)</option>
                                        <option value="3°" {{ old('curso', $estudiante->curso) == '3°' ? 'selected' : '' }}>Tercero (3°)</option>
                                        <option value="4°" {{ old('curso', $estudiante->curso) == '4°' ? 'selected' : '' }}>Cuarto (4°)</option>
                                        <option value="5°" {{ old('curso', $estudiante->curso) == '5°' ? 'selected' : '' }}>Quinto (5°)</option>
                                        <option value="6°" {{ old('curso', $estudiante->curso) == '6°' ? 'selected' : '' }}>Sexto (6°)</option>
                                        <option value="7°" {{ old('curso', $estudiante->curso) == '7°' ? 'selected' : '' }}>Séptimo (7°)</option>
                                        <option value="8°" {{ old('curso', $estudiante->curso) == '8°' ? 'selected' : '' }}>Octavo (8°)</option>
                                        <option value="9°" {{ old('curso', $estudiante->curso) == '9°' ? 'selected' : '' }}>Noveno (9°)</option>
                                        <option value="10°" {{ old('curso', $estudiante->curso) == '10°' ? 'selected' : '' }}>Décimo (10°)</option>
                                        <option value="11°" {{ old('curso', $estudiante->curso) == '11°' ? 'selected' : '' }}>Once (11°)</option>
                                    </select>
                                    @error('curso')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-lg @error('tipo_sangre') is-invalid @enderror" 
                                        ...
                                        <option value="A+" {{ old('tipo_sangre', $estudiante->tipo_sangre) == 'A+' ? 'selected' : '' }}>A+</option>
                                        <option value="A-" {{ old('tipo_sangre', $estudiante->tipo_sangre) == 'A-' ? 'selected' : '' }}>A-</option>
                                        <option value="B+" {{ old('tipo_sangre', $estudiante->tipo_sangre) == 'B+' ? 'selected' : '' }}>B+</option>
                                        <option value="B-" {{ old('tipo_sangre', $estudiante->tipo_sangre) == 'B-' ? 'selected' : '' }}>B-</option>
                                        <option value="AB+" {{ old('tipo_sangre', $estudiante->tipo_sangre) == 'AB+' ? 'selected' : '' }}>AB+</option>
                                        <option value="AB-" {{ old('tipo_sangre', $estudiante->tipo_sangre) == 'AB-' ? 'selected' : '' }}>AB-</option>
                                        <option value="O+" {{ old('tipo_sangre', $estudiante->tipo_sangre) == 'O+' ? 'selected' : '' }}>O+</option>
                                        <option value="O-" {{ old('tipo_sangre', $estudiante->tipo_sangre) == 'O-' ? 'selected' : '' }}>O-</option>
                                    </select>
                                    @error('tipo_sangre')
                                        <span class="invalid-feedback">{{ $message }}</span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-lg @error('activo') is-invalid @enderror" 
                                            id="activo" 
                                            name="activo">
