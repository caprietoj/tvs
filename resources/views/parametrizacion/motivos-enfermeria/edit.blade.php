...
@section('title', 'Editar Motivo de Enfermería')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="text-primary">
            <i class="fas fa-edit mr-2"></i>Editar Motivo: {{ $motivoEnfermeria->nombre }}
        </h1>
        <div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card card-outline card-warning">
                ...
                <div class="card-body">
                    <form action="{{ route('motivos-enfermeria.update', $motivoEnfermeria) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="nombre" 
                                           name="nombre" 
                                           value="{{ old('nombre', $motivoEnfermeria->nombre) }}" 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="orden" 
                                           name="orden" 
                                           value="{{ old('orden', $motivoEnfermeria->orden) }}" 
                                           min="1"
                                           required>
                                    @error('orden')
                                        <span class="invalid-feedback">{{ $message }}</span>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                              ...
                                              name="descripcion" 
                                              rows="3"
                                              placeholder="Descripción opcional del motivo...">{{ old('descripcion', $motivoEnfermeria->descripcion) }}</textarea>
                                    @error('descripcion')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="icono" 
                                           name="icono" 
                                           value="{{ old('icono', $motivoEnfermeria->icono) }}" 
                                           maxlength="10"
                                           placeholder="🤒 😷 🚑 etc.">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" 
                                               ...
                                               name="activo" 
                                               value="1"
                                               {{ old('activo', $motivoEnfermeria->activo) ? 'checked' : '' }}>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <span class="text-muted">{{ $motivoEnfermeria->created_at->format('d/m/Y H:i:s') }}</span>
                        </div>
                        <div class="col-md-6">
                            <strong>Última Actualización:</strong><br>
                            <span class="text-muted">{{ $motivoEnfermeria->updated_at->format('d/m/Y H:i:s') }}</span>
                        </div>
                    </div>
                </div>
            </div>
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            const currentIcon = $('#icono').val();
            if (currentIcon) {
                $(`.btn-icon[data-icon="${currentIcon}"]`).addClass('btn-primary').removeClass('btn-outline-primary');
            }
